...
| `ezai-persona-senior-dev`  | development | Elite Senior Developer persona for enterprise-grade Python and JavaScript/TypeScript projects. Apply for significant development tasks requiring senior-level judgment. |
