...
JS/TS-specific badges: npm version + tool badges. Combine with the platform badge registry (`github/badge-registry.md` or `gitlab/badge-registry.md`) for the full badge block.
