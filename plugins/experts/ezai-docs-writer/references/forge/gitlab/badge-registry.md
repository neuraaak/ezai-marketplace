...
GitLab-specific badge templates. Combine with the language badge registry (`languages/python/badge-registry.md` or `languages/javascript/badge-registry.md`) for the full badge block.
