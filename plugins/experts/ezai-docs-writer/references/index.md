...
| :-------------------------------------- | :------------------- | :----------------------------------------------------------- |
| Language-specific docs (docstrings, toolchain, deploy, badges) | `languages/index.md` | per-language routing + "load when" for Python and JS/TS       |
...
1. **Detect the language** (`pyproject.toml` → Python, `package.json` → JS/TS), then open `languages/index.md` and load the files it lists for the task.
